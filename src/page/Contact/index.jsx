        ...
        <div className="form-map-container">
          <div className="form-container">
            ...
            <div className="form-row form-row-tall form-row-extra-tall">
              <input type="text" className="form-input form-input-extra-tall" placeholder="Viết bình luận"/>
          ...
          <div className="map-container">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3724.2569476863396!2d105.8135202114788!3d21.022402487914885!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3135ab655ff22bfb%3A0xa1ff4776a6330b1a!2smindXCoworking%20Space%20(ti%E1%BB%81n%20th%C3%A2n%20Nest%20Coworking%20Space)!5e0!3m2!1sen!2s!4v1697344020855!5m2!1sen!2s" width="100%" height="100%" style={{ border: '0' }} allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
          </div>
        </div>
      </div>
    </div>
