            ...
            <div className="container1">
                <div className="footer__row">
                    <div className="footer__column">
                        <a href="#!">
                            <img
                                src="https://bizweb.dktcdn.net/100/488/521/themes/913255/assets/footers2_one_logo.png?1695187373377"
                                alt=""
                            />
                        </a>
                        <div className="column1">
                            ...
                            <p className="footer__desc">
                                188 Trường Chinh, P.Khương Thượng, Q.Đống Đa, Hà
                                Nội
                            </p>
                        </div>
                        <div className="column1">
                        ...
                        <div className="column1">
                            ...
                            <p className="footer__desc">BabyShop@gmail.com</p>
                        </div>
                        <div className="column1">
                    ...
                    <div className="footer__column">
                        ...
                        <p className="footer__desc">Baby Channel</p>
                ...
                <div className="footer__copyright">
                    ...
                    <p className="footer__copyright-text">
                        © 2023 - Bản quyền thuộc về F1GENZ TECHNOLOGY CO., LTD.
                        Cung cấp bởi Sapo
                    </p>
                </div>
            </div>
